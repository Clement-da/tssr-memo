        ...
        <nav class="lesson-toc" aria-label="Sommaire de la leçon">
            ...
            <div class="lesson-toc__body">
                ...
                <ol class="lesson-toc__list">
                    <li><a href="#unite1">1. Fondamentaux & Rôles de l'OS</a></li>
                    <li><a href="#unite2">2. L'écosystème Windows (WaaS, Licences)</a></li>
                    <li><a href="#unite3">3. Installation & Migration (USMT)</a></li>
                    <li><a href="#unite4">4. Gestion du Stockage (Partitionnement)</a></li>
                    <li><a href="#unite5">5. Utilisateurs & Groupes (SIDs)</a></li>
                    ...
                    <li><a href="#unite9">9. Maintenance & Diagnostics</a></li>
                    <li><a href="#unite10">10. Industrialisation & Déploiement</a></li>
