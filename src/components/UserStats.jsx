...
export default function UserStats() {
    ...
    return (
        <div className="user-stats" style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)', marginLeft: 'auto' }}>
            <div className="xp-container" style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end' }}>
                <div style={{ display: 'flex', gap: 'var(--space-2)', alignItems: 'center' }}>
                    ...
                    <span style={{ fontWeight: 700, color: 'var(--accent-primary)', fontSize: '0.85rem' }}>{levelInfo.name}</span>
                </div>
                <div className="xp-bar-outer" style={{ width: '100px', height: '6px', background: 'var(--bg-base)', borderRadius: '10px', marginTop: '4px', overflow: 'hidden', border: '1px solid var(--border-color)' }}>
